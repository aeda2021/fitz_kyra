...
The QQ plot looks good, and the points follow the red line nicely. The residuals vs. predicted plot has points spread out evenly, and looks appropriate. The correlogram looks better than before with only a glm. Each residuals vs. explanatory plots also appear to be evenly distributed and look okay. 
